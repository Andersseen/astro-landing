...
const projects = [
  {
    ...
    description:
      "Creating immersive digital experiences that connect with your audience.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Evolving brands through strategic design and creative direction.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Innovative solutions that push the boundaries of digital design.",
    imageUrl:
